            ...
            <Nav />
                <div className='Home-Body'>
                    <div className="generic-block-wrapper">
                        <img src='https://images4.alphacoders.com/190/thumb-1920-19098.jpg' alt='Home-img' className='Home-Main-Img'/>
                    ...
                    <div className='Home-Sec-Wrapper'>
                        <img src='https://www.hypable.com/wp-content/uploads/2015/08/star-wars-land-disney-world.jpg' alt='Home-Img2' className='Home-Sec-Img' />
                    </div>
                </div>
            </div>
        );
